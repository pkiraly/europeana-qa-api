...
public class EdmMultilingualitySaturationCalculator implements Calculator, Serializable {
  ...
  private MultilingualityResultType resultType = MultilingualityResultType.NORMAL;
  ...
  private FieldCounter<Double> calculateScore(Map<String,
    ...
    for (String field : rawLanguageMap.keySet()) {
      ...
      if (resultType.equals(MultilingualityResultType.NORMAL)) {
    ...
    normalized = normalize(average);
    if (resultType.equals(MultilingualityResultType.EXTENDED)) {
  ...
  public MultilingualityResultType getResultType() {
    return resultType;
  }

  public void setResultType(MultilingualityResultType resultType) {
